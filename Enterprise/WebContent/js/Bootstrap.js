...
function dumpMenu(container, type) {
	if(type=="junior") {
		...
		dumpMenuItem(hasModule("vmmanagement"), subMenu, menuli("modules/Instance/index.html", Locale["navigation.menu.junior.vmman"]));
		dumpMenuItem(hasModule("ipmanagement"), subMenu, menuli("modules/Network/index.html", Locale["navigation.menu.junior.ipman"]));
		dumpMenuItem(hasModule("volumemanagement"), subMenu, menuli("modules/Volume/index.html", Locale["navigation.menu.junior.diskman"]));
		...
		dumpMenuItem(hasModule("vmmanagement"), subMenu, menuli("modules/OrderTemplate/index.html", Locale["navigation.menu.senior.buyvm"]));
		...
		dumpMenuItem(hasModule("apptemplatemanagement"), subMenu, menuli("modules/Bedivere/index.html", Locale["navigation.menu.senior.buytemplate"]));
		dumpMenuItem(hasModule("projectmanagement"), subMenu, menuli("modules/Project/index.html", Locale["navigation.menu.senior.buyproject"]));
		...
		dumpMenuItem(hasModule("vmmanagement"), subMenu, menuli("modules/Instance/index.html", Locale["navigation.menu.senior.vmman"]));
		dumpMenuItem(hasModule("ipmanagement"), subMenu, menuli("modules/Network/index.html", Locale["navigation.menu.senior.ipman"]));
		dumpMenuItem(hasModule("volumemanagement"), subMenu, menuli("modules/Volume/index.html", Locale["navigation.menu.senior.diskman"]));
		dumpMenuItem(hasModule("vlanmanagement"), subMenu, menuli("modules/VLan/index.html", Locale["navigation.menu.senior.vlanman"]));
		dumpMenuItem(hasModule("groupmanagement"), subMenu, menuli("modules/Group/index.html", Locale["navigation.menu.senior.groupman"]));
		...
		dumpMenuItem(hasModule("backup"), subMenu, menuli("modules/Backup/index.html", Locale["navigation.menu.senior.backup"]));
		dumpMenuItem(hasModule("apptemplatemanagement"), subMenu, menuli("modules/Bedivere/index.html?action=instance", Locale["navigation.menu.senior.templateman"]));
		dumpMenuItem(hasModule("projectmanagement"), subMenu, menuli("modules/Project/index.html?action=manage", Locale["navigation.menu.senior.projectman"]));
		dumpMenuItem(true, subMenu, menuli("modules/Monitor/index.html", Locale["navigation.menu.senior.monitor"]));
		dumpMenuItem(true, subMenu, menuli("modules/Elastic/index.html", Locale["navigation.menu.senior.elastic"]));
		...
		dumpMenuItem(hasModule("requestmanagement"), subMenu, menuli("modules/MyNetReqMan/index.html", Locale["navigation.menu.senior.mynetreqman"]));
		dumpMenuItem(hasModule("requestmanagement"), subMenu, menuli("modules/VMReqClient/index.html", Locale["navigation.menu.senior.vmreqclient"]));
		dumpMenuItem(hasModule("requestmanagement"), subMenu, menuli("modules/VolumeReqClient/index.html", Locale["navigation.menu.senior.volumereqclient"]));

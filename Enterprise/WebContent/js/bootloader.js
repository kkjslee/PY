	...
	conf:{
		...
		dataTable: function(dataTable) {
			...
			return	{
				...
				"aLengthMenu": (window.JSON && JSON.parse("<!--#echo var='DataTableLength'-->")) || null, // set entries length option if available
				"iDisplayLength": (window.JSON && JSON.parse("<!--#echo var='DataTableLength'-->")[0]) || null, // set items[0] as the default

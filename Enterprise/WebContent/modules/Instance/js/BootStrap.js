...
// Modified By RShao, 2012~2013

var _DEBUG_=false;
var novaServer = Server + ":" + "8774/v2/"
$(function(){
...
function loadVm() {
	...
	$.ajax({
		type: "GET",
		url: novaServer + tennantId +"/servers/detail",
		cache: false,
		headers:{
			Content-type:"application/json",
			Accept: "application/json",
			X-Auth-Token: cloudToken
		}
					...
					buttons: [
						{
							...
							click: function() {
								var userpass=getPassword(); // get user password to clone
...
function formatOstype(ostype) {
	...
	}else if(ostype.toLowerCase().match("linux|centos|ubunto|ubuntu|debian")){

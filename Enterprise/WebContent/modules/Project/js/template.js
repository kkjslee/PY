...
<div id="${paneid}" title="'+Locale["project.banner"]+'" class="projectPreview">\
...
<span class="appInstListRow">\
	...
	<span class="appInstListCell instOperation textCollapse">\
		...
		<span class="_operation">\
			<a href="#" onclick="removeProject(\'${projectid}\', this);return false;">'+Locale["project.template.remove"]+'</a>\
		</span>\

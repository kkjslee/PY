...
<title></title>
<script src="<%=request.getContextPath()%>/resource/admin/network/bootstrap.js" language="javascript"></script>
</head>
<body>
<div class="banner">
    <label>
...
<script>setServer("<%=request.getContextPath()%>/admin/quantum");</script>
</body>
</html>
	...
	conf:{
		...
		dataTable: function(dataTable) {
			...
			return	{
				...
				"oLanguage": {
				    "sProcessing":   "<spring:message code='admin.sProcessing'/>",
				    "sLengthMenu":   "<spring:message code='admin.dataTable.sLengthMenu'/>",
				    "sZeroRecords":  "<spring:message code='admin.dataTable.sZeroRecords'/>",
				    "sInfo":         "<spring:message code='admin.dataTable.sInfo'/>",
				    "sInfoEmpty":    "<spring:message code='admin.dataTable.sInfoEmpty'/>",
				    "sInfoFiltered": "<spring:message code='admin.dataTable.sInfoFiltered'/>",
				    "sInfoPostFix":  "",
				    "sSearch":       "<spring:message code='admin.dataTable.sSearch'/>",
				    "sUrl":          "",
				    "oPaginate": {
				        "sFirst":    "<spring:message code='admin.dataTable.oPaginate.sFirst'/>",
				        "sPrevious": "<spring:message code='admin.dataTable.oPaginate.sPrevious'/>",
				        "sNext":     "<spring:message code='admin.dataTable.oPaginate.sNext'/>",
				        "sLast":     "<spring:message code='admin.dataTable.oPaginate.sLast'/>"
				    }
				},

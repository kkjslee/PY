...
<!--[if lte IE 6]>
<link ref="${rPath}/template/bootstrap2.2.1/css/bootstrap-ie6.css" rel="stylesheet" type="text/css" />
<![endif]-->
<!--[if lte IE 7]>
<link ref="${rPath}/template/bootstrap2.2.1/css/ie.css" rel="stylesheet" type="text/css" />
...
<!--[if lte IE 6]>
 <script src="${rPath}/template/bootstrap/js/bootstrap-ie.js" type="text/javascript"></script>
<![endif]-->
...
/* 
    ...
    $('#regBtn').click(function(){
        ...
        if(!isok) {
            ...
            $('#c_etc_6').html($('#etc_6').val());
            $('#c_etc_11').html($('#etc_11').val());
...
<tr style='text-align:left;'>
    <td colspan='5' style='font-weight:bold;line-height:24px;padding-left:32px;border:1px solid silver;background:url(${rPath}/image/images/menu_downarrow.png) 10px center no-repeat #f0f0f0;'>基本信息</td>
</tr>
...
<tr style="border-bottom:1px dashed silver;">
    ...
    <select id='question' title="密码找回提示问题">
...
<tr style='text-align:left;'>
    <td colspan='5' style='font-weight:bold;line-height:24px;padding-left:32px;border:1px solid silver;background:url(${rPath}/image/images/menu_downarrow.png) 10px center no-repeat #f0f0f0;'>可选信息</td>
</tr>
<tr style="border-bottom:1px dashed silver;">
    <td class="reg_ltd"><label class="reg_label">公司组织：</label></td>
    <td><input id="etc_11" class="reg_input" type="text" /></td>
    <td></td>
    <td></td>
...
<tr style="border-bottom:1px dashed silver;">
    ...
    <td><input id="etc_6" class="reg_input" type="text" /></td>
    <td></td>
    <td></td>
    <td><div></div></td>
</tr>
...
<tr><td style="height:40px;">&nbsp;</td><td>&nbsp;</td></tr>
<tr style='text-align:left;'>
    <td colspan='4' style='font-weight:bold;line-height:24px;padding-left:32px;border:1px solid silver;background:url(${rPath}/image/images/menu_downarrow.png) 10px center no-repeat #f0f0f0;'>可选信息</td>
</tr>
<tr style='border-bottom:1px dashed silver;'>
    <td class="reg_ltd"><label class="reg_label">公司组织：</label></td>
    <td class='reg_rtd'><label id="c_etc_11"></label></td>
    <td></td><td>&nbsp;</td>
</tr>
<tr style='border-bottom:1px dashed silver;'>
    <td class="reg_ltd"><label class="reg_label">联系电话：</label></td>
    <td class='reg_rtd'><label id="c_etc_6"></label></td>
    <td>&nbsp;</td><td>&nbsp;</td>
</tr>
<tr style='border-bottom:1px dashed silver;'>
    <td class="reg_ltd"><label class="reg_label">地址：</label></td>
...
<div style='display:none;' id="checkDialog" title="提示">
    <p><img src='${rPath}/image/bigimg/alert.png' style='width:60px;vertical-align:top;'/>

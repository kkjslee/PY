        ...
        <div id="sidebar_menu" class="accordion">
            ...
            <div class="accordion-group">
                 ...
                 <div id="ncollapse2" class="accordion-body collapse">
                    <ul class="accordion-inner">
                        ...
                        <li><a href="#" name="menuItem" isos:module="instance/modules/instanceStatus"><spring:message code='user.navi.instanceStatus' /></a></li>
                    </ul>
                </div>
            </div>
            <div class="accordion-group">
            ...
            <div class="accordion-group">
                 ...
                 <div id="ncollapse5" class="accordion-body collapse">
                    <ul class="accordion-inner">
                          <li><a href="#" name="menuItem" isos:module="showedit"><spring:message code='user.navi.userinfo' /></a></li>
                    </ul>
                </div>
            </div>
            <div class="accordion-group">

...
<c:set var="rPath" value="${request.contextPath}/resource/common" scope="page"/>
...
<tr style="border-bottom:1px dashed silver;">
    <td class="reg_ltd"><label class="reg_label">电话号码&nbsp;<label style="color:#F60;font-weight:bold;font-size:18px;">*</label>&nbsp;：</label></td>
...
<tr style="border-bottom:1px dashed silver;">
    <td class="reg_ltd"><label class="reg_label">组织用户名：</label></td>
    <td><input id="tenant_name" class="reg_input" type="text" /></td>
    <td></td>
    <td></td>
...
<tr style="border-bottom:1px dashed silver;">
    <td class="reg_ltd"><label class="reg_label">邮箱：</label></td>
...
<tr style="border-bottom:1px dashed silver;">
    <td class="reg_ltd"><label class="reg_label">确认输入邮箱：</label></td>

...
beans = {
     ...
     */
    customPropertyEditorRegistrar(com.infosense.ibilling.client.editor.CustomPropertyEditorRegistrar) {
    ...
    securitySession(com.infosense.ibilling.client.authentication.util.SecuritySession) {
        localeResolver = ref('localeResolver')
    }

    // normal username / password authentication
    authenticationProcessingFilter(com.infosense.ibilling.client.authentication.CompanyUserAuthenticationFilter) {
    ...
    rememberMeAuthenticationFilter(com.infosense.ibilling.client.authentication.CompanyUserRememberMeFilter) {
        authenticationManager = ref('authenticationManager')
        rememberMeServices = ref('rememberMeServices')
        securitySession = ref('securitySession')
    }
     ...
     */
    staticAuthenticationProcessingFilter(com.infosense.ibilling.client.authentication.StaticAuthenticationFilter) {
        authenticationManager = ref("authenticationManager")
    ...
    userDetailsService(com.infosense.ibilling.client.authentication.CompanyUserDetailsService) {
    ...
    webExpressionVoter(com.infosense.ibilling.client.authentication.SafeWebExpressionVoter) {
    ...
    viewUtils(com.infosense.ibilling.client.ViewUtils) {
        messageSource = ref("messageSource")
    }
}

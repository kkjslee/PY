...
<%@ page import="com.infosense.ibilling.server.user.UserDTOEx; com.infosense.ibilling.server.user.contact.db.ContactTypeDTO; com.infosense.ibilling.server.user.db.CompanyDTO; com.infosense.ibilling.server.user.permisson.db.RoleDTO; com.infosense.ibilling.common.Constants; com.infosense.ibilling.server.util.db.LanguageDTO" %>
<html>
<head>
                        ...
                        <g:applyLayout name="form/text">
                            ...
                            <div class="select4">
                                <g:select from="${periodUnits}"
                                          ...
                                          value="${user?.dueDateUnitId ?: com.infosense.ibilling.server.util.Constants.PERIOD_UNIT_DAY}"/>
                            </div>
                        </g:applyLayout>
                    </div>
                </div>

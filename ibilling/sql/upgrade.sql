...
insert into pluggable_task_type  (id, category_id, class_name, min_parameters) values (84, 17, 'com.infosense.ibilling.server.payment.tasks.SaveACHExternallyTask', 1);
...
insert into pluggable_task_type values (85, 20, 'com.infosense.ibilling.server.process.task.BillableUserOrdersBillingProcessFilterTask', 0);
...
-- ageing plug-ins
insert into pluggable_task_type_category (id, interface_name) values (24, 'com.infosense.ibilling.server.process.task.IAgeingTask');

insert into pluggable_task_type (id, category_id, class_name, min_parameters) values (87, 24, 'com.infosense.ibilling.server.process.task.BasicAgeingTask', 0);
insert into pluggable_task_type (id, category_id, class_name, min_parameters) values (88, 22, 'com.infosense.ibilling.server.process.task.AgeingProcessTask', 0);
insert into pluggable_task_type (id, category_id, class_name, min_parameters) values (89, 24, 'com.infosense.ibilling.server.process.task.BusinessDayAgeingTask', 0);

...
import com.infosense.ibilling.server.invoice.db.InvoiceLineDAS;
import com.infosense.ibilling.server.invoice.db.InvoiceLineDTO;
...
import com.infosense.ibilling.server.order.db.OrderProcessDAS;
...
public class InvoiceBL extends ResultList implements Serializable, InvoiceSQL {
    ...
    public void create(Integer userId, NewInvoiceDTO newInvoice,
        ...
        try {
            ...
            Date lastDate = com.infosense.ibilling.common.Util.parseDate(pref.getString());
            if (lastDate.after(newInvoice.getBillingDate())) {
                ...
                if (newInvoice.getIsReview() == null || newInvoice.getIsReview().intValue() == 0) {
                    pref.createUpdateForEntity(entityId,
                                               ...
                                               com.infosense.ibilling.common.Util.parseDate(newInvoice.getBillingDate()));
                }
            }
...
//?        if (invoice.getBalance().floatValue() <= 0.001F) {
    ...
    public static InvoiceWS getWS(InvoiceDTO i) {
        ...
        com.infosense.ibilling.server.entity.InvoiceLineDTO invoiceLines[] = 
                new com.infosense.ibilling.server.entity.InvoiceLineDTO[i.getInvoiceLines().size()];
        ...
        for (InvoiceLineDTO line : i.getInvoiceLines()) {
            invoiceLines[f++] = new com.infosense.ibilling.server.entity.InvoiceLineDTO(line.getId(), 
    ...
    public static InvoiceWS getWS(InvoiceDTO dto) {
        ...
        com.infosense.ibilling.server.entity.InvoiceLineDTO lines[] = 
                new com.infosense.ibilling.server.entity.InvoiceLineDTO[dto.getInvoiceLines().size()];
        
        f=0;
        for (InvoiceLineDTO line : dto.getInvoiceLines()) {
            lines[f++] = new com.infosense.ibilling.server.entity.InvoiceLineDTO(line.getId(), 
                    line.getDescription(), line.getAmount(), line.getPrice(), line.getQuantity(), 
                    line.getDeleted(), line.getItem() == null ? null : line.getItem().getId(), 
                    line.getSourceUserId(), line.getIsPercentage());
        }

...
public class InvoiceSessionBean implements IInvoiceSessionBean {
    ...
    public String generatePDFFile(java.util.Map map, String realPath) throws SessionInternalError {
        ...
        try {
            ...
            if (operationType.equals(com.infosense.ibilling.common.Constants.OPERATION_TYPE_CUSTOMER)) {
            ...
            } else if (operationType.equals(com.infosense.ibilling.common.Constants.OPERATION_TYPE_RANGE)) {
                //security check is done in SQL
                cachedRowSet = invoiceBL.getInvoicesByIdRange(
                        (Integer) map.get("from"),
                        (Integer) map.get("to"),
                        entityId);
            } else if (operationType.equals(com.infosense.ibilling.common.Constants.OPERATION_TYPE_PROCESS)) {
            ...
            } else if (operationType.equals(com.infosense.ibilling.common.Constants.OPERATION_TYPE_DATE)) {
            ...
            } else if (operationType.equals(com.infosense.ibilling.common.Constants.OPERATION_TYPE_NUMBER)) {

...
public class BasicItemManager extends PluggableTask implements IItemPurchaseManager {
     ...
     *
     * @see ItemBL#getDTO(Integer, Integer, Integer, Integer, java.math.BigDecimal, com.infosense.ibilling.server.order.db.OrderDTO)
     * @see ItemBL#getPrice(Integer, Integer, java.math.BigDecimal, Integer, com.infosense.ibilling.server.order.db.OrderDTO)
     *

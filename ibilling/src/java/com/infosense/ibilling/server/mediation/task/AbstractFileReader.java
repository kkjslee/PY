...
import com.infosense.ibilling.server.mediation.Format;
import com.infosense.ibilling.server.mediation.FormatField;
...
public abstract class AbstractFileReader extends AbstractReader {
    ...
    protected Format getFormat() throws IOException, SAXException {
        ...
        if (format == null) {
            ...
            digester.addObjectCreate("format", "com.infosense.ibilling.server.mediation.Format");
            digester.addObjectCreate("format/field", "com.infosense.ibilling.server.mediation.FormatField");
            ...
            digester.addSetNext("format/field", "addField", "com.infosense.ibilling.server.mediation.FormatField");

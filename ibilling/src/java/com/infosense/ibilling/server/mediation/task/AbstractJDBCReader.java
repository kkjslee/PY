...
/**
 * AbstractJDBCReader provides a generic base for all JDBC {@link com.infosense.ibilling.server.mediation.task.IMediationReader} classes.
 *
 * @see JDBCUtils
 * 
...
public abstract class AbstractJDBCReader extends AbstractReader {
    ...
    /**
     * Returns true if read {@link com.infosense.ibilling.server.item.PricingField} names should be
     ...
     * the reader {@link com.infosense.ibilling.server.mediation.task.AbstractJDBCReader.MarkMethod} ({@link #getMarkMethod()} to limit records to those that

...
package com.infosense.ibilling.server.payment;

import com.infosense.ibilling.common.SessionInternalError;
import com.infosense.ibilling.server.invoice.InvoiceIdComparator;
...
import com.infosense.ibilling.server.notification.INotificationSessionBean;
...
import com.infosense.ibilling.server.notification.NotificationNotFoundException;
...
import com.infosense.ibilling.server.payment.db.PaymentInfoChequeDAS;
import com.infosense.ibilling.server.payment.db.PaymentInfoChequeDTO;
import com.infosense.ibilling.server.payment.db.PaymentInvoiceMapDAS;
import com.infosense.ibilling.server.payment.db.PaymentInvoiceMapDTO;
...
import com.infosense.ibilling.server.payment.db.PaymentResultDTO;
import com.infosense.ibilling.server.payment.event.AbstractPaymentEvent;
import com.infosense.ibilling.server.payment.event.PaymentDeletedEvent;
import com.infosense.ibilling.server.pluggableTask.PaymentInfoTask;
...
import com.infosense.ibilling.server.user.db.CreditCardDAS;
import com.infosense.ibilling.server.user.db.CreditCardDTO;
import com.infosense.ibilling.server.user.db.UserDAS;
import com.infosense.ibilling.server.user.partner.db.PartnerPayout;
...
// the payment period length this payment was expected to last
    ...
    public static PaymentWS getWS(PaymentDTOEx dto) {
        ...
        if (dto.getCreditCard() != null) {
            com.infosense.ibilling.server.entity.CreditCardDTO ccDTO = new com.infosense.ibilling.server.entity.CreditCardDTO();
        ...
        if (dto.getCheque() != null) {
            com.infosense.ibilling.server.entity.PaymentInfoChequeDTO chqDTO = new com.infosense.ibilling.server.entity.PaymentInfoChequeDTO();
        ...
        if (dto.getAch() != null) {
            com.infosense.ibilling.server.entity.AchDTO achDTO = new com.infosense.ibilling.server.entity.AchDTO();
        ...
        if (dto.getAuthorization() != null) {
            com.infosense.ibilling.server.entity.PaymentAuthorizationDTO authDTO = new com.infosense.ibilling.server.entity.PaymentAuthorizationDTO();

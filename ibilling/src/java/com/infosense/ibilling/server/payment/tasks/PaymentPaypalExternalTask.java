...
import com.infosense.ibilling.server.payment.PaymentAuthorizationBL;
import com.infosense.ibilling.server.payment.PaymentDTOEx;
import com.infosense.ibilling.server.payment.db.*;
import com.infosense.ibilling.server.payment.tasks.paypal.PaypalApi;
import com.infosense.ibilling.server.payment.tasks.paypal.dto.*;
import com.infosense.ibilling.server.pluggableTask.PaymentTaskWithTimeout;
...
public class PaymentPaypalExternalTask extends PaymentTaskWithTimeout implements IExternalCreditCardStorage {
    ...
    public void updateGatewayKey(PaymentDTOEx payment) {
        ...
        if (!com.infosense.ibilling.common.Constants.PAYMENT_METHOD_GATEWAY_KEY.equals(card.getCcType()))
            card.obscureNumber();
    }

...
import com.infosense.ibilling.server.payment.IExternalCreditCardStorage;
...
import com.infosense.ibilling.server.user.db.AchDAS;
import com.infosense.ibilling.server.user.db.AchDTO;
import com.infosense.ibilling.server.user.event.AchDeleteEvent;
import com.infosense.ibilling.server.user.event.AchUpdateEvent;

import org.apache.log4j.Logger;

import static com.infosense.ibilling.server.pluggableTask.admin.ParameterDescription.Type.*;
...
public class SaveACHExternallyTask extends PluggableTask implements IInternalEventsTask {
     ...
     *
     * @return contact type
     * @throws com.infosense.ibilling.server.pluggableTask.admin.PluggableTaskException if type cannot be converted to an integer
     */
    ...
    /**
     * Returns the configured external saving event plugin id ({@link com.infosense.ibilling.server.payment.IExternalCreditCardStorage})
     * as an integer.
     *
    ...
    /**
     * @see IInternalEventsTask#process(com.infosense.ibilling.server.system.event.Event)
     *

...
public class PaymentACHCommerceTask extends PaymentTaskBase {
     ...
     * Debit card transactions and therefore simply returns false.
     * 
     * @see com.infosense.ibilling.server.pluggableTask.PaymentTask#preAuth(com.infosense.ibilling.server.payment.PaymentDTOEx)
     */
    ...
    /* (non-Javadoc)
     * @see com.infosense.ibilling.server.pluggableTask.PaymentTask#process(com.infosense.ibilling.server.payment.PaymentDTOEx)
     */

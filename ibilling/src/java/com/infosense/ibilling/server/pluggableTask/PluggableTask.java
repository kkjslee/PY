    ...
    private String createChangeSetStringFromTaskParameters() {
        ...
        for (String key : parameters.keySet()) {
            ...
            if (StringUtils.isNotEmpty(value)) {
                if (key.equals("file")) {
                    String[] files = com.infosense.ibilling.server.util.Util
                            .csvSplitLine(value, ' ');
                    ...
                    String[] dirs = com.infosense.ibilling.server.util.Util
                            .csvSplitLine(value, ' ');
                    for (String dir : dirs) {
                        prefix = "";
                    ...
                    String[] urls = com.infosense.ibilling.server.util.Util
                            .csvSplitLine(value, ' ');
                    for (String url : urls) {

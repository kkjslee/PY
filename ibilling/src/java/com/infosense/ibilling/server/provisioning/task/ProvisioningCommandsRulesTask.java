...
import com.infosense.ibilling.server.provisioning.event.SubscriptionInactiveEvent;
...
public class ProvisioningCommandsRulesTask extends PluggableTask implements IInternalEventsTask {
     ...
     * 
     * @see
     * com.infosense.ibilling.server.system.event.task.IInternalEventsTask#process(com.infosense.ibilling.server.system.event.Event)
     */

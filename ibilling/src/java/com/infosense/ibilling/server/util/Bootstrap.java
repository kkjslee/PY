...
import com.infosense.ibilling.client.process.JobScheduler;
import com.infosense.ibilling.client.process.Trigger;
...
import com.infosense.ibilling.server.process.task.IScheduledTask;
            ...
            for (CompanyDTO entity : new CompanyDAS().findEntities()) {
                PluggableTaskManager<IScheduledTask> manager =
                        new PluggableTaskManager<IScheduledTask>
                                (entity.getId(), com.infosense.ibilling.server.util.Constants.PLUGGABLE_TASK_SCHEDULED);

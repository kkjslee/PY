...
import com.infosense.ibilling.server.item.IItemSessionBean;
...
import com.infosense.ibilling.server.mediation.db.MediationRecordLineDAS;
import com.infosense.ibilling.server.mediation.db.MediationRecordLineDTO;
import com.infosense.ibilling.server.mediation.db.MediationRecordStatusDAS;
import com.infosense.ibilling.server.mediation.db.MediationRecordStatusDTO;
...
import com.infosense.ibilling.server.order.IOrderSessionBean;
...
import com.infosense.ibilling.server.user.db.CustomerDAS;
...
public class WebServicesSessionSpringBean implements IWebServicesSessionBean {
    ...
    public Integer[] getInvoicesByDate(String since, String until)
            throws SessionInternalError {
        try {
            Date dSince = com.infosense.ibilling.common.Util.parseDate(since);
            Date dUntil = com.infosense.ibilling.common.Util.parseDate(until);
...
//    }
    ...
    private OrderWS getWSFromOrder(OrderBL bl, Integer languageId) {
        ...
        OrderWS retValue = new OrderWS(order.getId(), order.getBillingTypeId(),
                ...
                order.getVersionNum(), order.getCycleStarts(), order.getParentOrderId(), order.getOrderType());
     ...
     * @throws SessionInternalError
     */
    public void updateCreditCard(Integer userId, com.infosense.ibilling.server.entity.CreditCardDTO creditCard)
            throws SessionInternalError {
     ...
     * @throws SessionInternalError
     */
    public void updateAch(Integer userId, com.infosense.ibilling.server.entity.AchDTO ach)
            throws SessionInternalError {

...
public interface JbillingAPI {
    ...
    public String isUserSubscribedTo(Integer userId, Integer itemId) throws JbillingAPIException;
    ...
    public PaymentAuthorizationDTOEx processPayment(PaymentWS payment,Integer invoiceId) throws JbillingAPIException;

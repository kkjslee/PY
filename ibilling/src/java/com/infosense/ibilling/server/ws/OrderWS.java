...
import com.infosense.ibilling.server.order.validator.DateBetween;
import com.infosense.ibilling.server.order.validator.DateRange;
import com.infosense.ibilling.server.order.validator.IsNotEmptyOrDeleted;
...
public class OrderWS implements WSSecured, Serializable {
    ...
    public OrderWS(Integer id, Integer billingTypeId, Integer notify, Date activeSince, Date activeUntil,
                   ...
                   Integer ownInvoice, Integer period, Integer userId, Integer version, Date cycleStarts, Integer parentOrderId, Integer orderType) {
        setId(id);

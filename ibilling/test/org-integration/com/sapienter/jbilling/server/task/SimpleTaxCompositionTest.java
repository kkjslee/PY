...
package com.infosense.ibilling.server.task;
...
//    }
    ...
    private OrderWS createOrderWS(int userId, int itemId, BigDecimal price) {
        ...
        newOrder.setBillingTypeId(com.infosense.ibilling.server.util.Constants.ORDER_BILLING_POST_PAID);
    ...
    private OrderLineWS createOrderLine(int itemId, BigDecimal price) {
        ...
        line.setPrice(price);
        line.setTypeId(com.infosense.ibilling.server.util.Constants.ORDER_LINE_TYPE_ITEM);
        line.setQuantity(1);

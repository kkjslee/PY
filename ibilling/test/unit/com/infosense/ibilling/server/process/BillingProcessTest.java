...
public class BillingProcessTest extends TestCase {
    ...
    public void testEndOfMonthCorrection() throws Exception {
        ...
        */
        ...
        // user for tests
        UserWS user = com.infosense.ibilling.server.user.WSTest.createUser(true, null, null);
        OrderWS order = com.infosense.ibilling.server.order.WSTest.createMockOrder(user.getUserId(),
                                                                                   1,
                                                                                   new BigDecimal(60));
        ...
        Integer[] invoiceIds = api.getLastInvoices(user.getUserId(),10);
...
//                         bTotal.getTotalInvoiced());
    ...
    public void testGeneratedInvoices() {
        ...
        try {
			...
			invoiceIds = api.getBillingProcessGeneratedInvoices(api.getLastBillingProcess());
...
//                               .floatValue() < 1);
    ...
    public void testBillingProcessFailure() throws Exception {
        ...
        UserWS user = com.infosense.ibilling.server.user.WSTest
                .createUser(true, null, null);

        OrderWS brokenOrder = com.infosense.ibilling.server.order.WSTest

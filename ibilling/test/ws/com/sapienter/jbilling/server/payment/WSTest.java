...
public class WSTest extends TestCase {
    ...
    public void testRemoveOnCCChange() throws Exception {
        ...
        api.createOrderPreAuthorize(com.infosense.ibilling.server.order.WSTest.createMockOrder(userId, 3, new BigDecimal("3.45")));
    ...
    public void testProcessPayment(){
        try {
            ...
            OrderWS order = com.infosense.ibilling.server.order.WSTest.createMockOrder(USER_ID, 1, new BigDecimal("10.00"));
